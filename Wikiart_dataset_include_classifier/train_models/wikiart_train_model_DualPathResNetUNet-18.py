...
from models.DualPathResNet18_UNet import DualPathResNet18_UNet
...
def train_model(model, optimizer, epochs=1, scheduler=None,dataloader_train=dataloader_train,dataloader_val=dataloader_val):
    ...
    return model
learning_rate = 3e-2
net = DualPathResNet18_UNet(num_classes=11)
...
scheduler=optim.lr_scheduler.CosineAnnealingLR(optimizer_net, T_max=100)

def which_model():
    return 'DualPathResNet18-UNet'
